...
if ( totalShoppingCart > 50 ) {
  ...
  costoTotale = totalShoppingCart + 10;
}
console.log( "checkout totale " + costoTotale)
*/
...
if (isBlackFriday) {
  scontoBlack = totalShoppingCart / 1.20;
} else {
  scontoBlack = totalShoppingCart;
}
...
/* ESERCIZIO EXTRA 5
  Scrivi un algoritmo che iteri i numeri da 1 a 100, stampandoli in console. Se un valore tuttavia è multiplo di
   3 (operatore modulo!), stampa al suo posto la parola "Fizz" e se il numero è multiplo di 5, stampa "Buzz".
